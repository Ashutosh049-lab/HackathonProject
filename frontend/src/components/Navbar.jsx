      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          >
            <Link
              to="/"
              className="flex items-center space-x-2 font-bold text-xl md:text-2xl tracking-wide bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-transparent bg-clip-text hover:opacity-80 transition"
            >
              <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center text-white text-sm md:text-base font-bold">
                IC
              </div>
              <span className="hidden sm:block">Improve My City</span>
            </Link>
          </motion.div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <FiChevronDown className={`w-4 h-4 transition-transform ${profileDropdown ? 'rotate-180' : ''}`} />
                  </motion.button>
          ...
          <div className="lg:hidden flex items-center space-x-4">
            {user && (
              <div className="flex items-center space-x-2">
                ...
                {user.role === 'admin' && <FiShield className="w-4 h-4 text-orange-500" />}
              </div>
            )}
            <motion.button
              whileTap={{ scale: 0.95 }}
